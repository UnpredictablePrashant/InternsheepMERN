					...
					<div className="main-bar clearfix">
						<div className="container clearfix">
							...
							<div className="logo-header mostion">
								<Link to={"/"}><img src={logo2} className=" h-auto logo" alt="img" /></Link>
							</div>
							...
							<div className="extra-nav">
								<div className="extra-cell">
									...
									{
										user == null ? <>
											<Link to={"/login"} style={{ fontSize: '.8rem', padding: '5px 1rem ' }} className="text-xs site-button"> Login</Link>
											<Link to={"/register/student"} style={{ fontSize: '.8rem', padding: '5px 1rem ' }} className="text-xs site-button"> Sign Up as Student</Link>
											<Link to={"/register/company"} style={{ fontSize: '.8rem', padding: '5px 1rem ' }} className="text-xs site-button"> Sign Up as Organisation</Link>
										</>
											:
											<>
												<Link to={`${user && user.role == 'student' ? '/student-profile' : '/company-profile'}`} style={{ fontSize: '.8rem', padding: '5px 1rem ' }} className="text-xs site-button">My Profile</Link>
							...
							<div className="header-nav navbar-collapse collapse myNavbar justify-content-start" id="navbarNavDropdown">
								...
								<ul className="nav navbar-nav">
										...
										</li> */}
									{
										...
										<li >
											<Link to={'#'} >My Profile <i className="fa fa-chevron-down"></i></Link>
											<ul className="sub-menu">
												<li><Link to={"/student-profile"} className="dez-page">My Profile<span className="new-page">New</span></Link></li>
												<li><Link to={"/student-my-resume"} className="dez-page">My Resume <span className="new-page">New</span></Link></li>
												<li><Link to={"/student-applied-job"} className="dez-page">Applied Job <span className="new-page">New</span></Link></li>
												<li><Link to={"/student-alerts"} className="dez-page">Jobs Alerts <span className="new-page">New</span></Link></li>
												<li><Link to={"/student-saved-jobs"} className="dez-page">Saved Job <span className="new-page">New</span></Link></li>
												<li><Link to={"/student-cv-manager"} className="dez-page">CV Manager <span className="new-page">New</span></Link></li>
												<li><Link to={"/student-change-password"} className="dez-page">Change Password <span className="new-page">New</span></Link></li>
											</ul>
										</li>
									}
									{
										...
										<li >
											<Link to={'#'} >Company Profile <i className="fa fa-chevron-down"></i></Link>
											<ul className="sub-menu">
